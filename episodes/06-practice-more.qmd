...
For studies with multiple experimental factors, it's often useful to _combine_ different factors into a new variable. Then, your design formula becomes as simple as `~ condition`.
