...
We can plot the DESeq2-normalized counts of two genes, just to confirm that the volcano plot is correct. We pick one that is highly upregulated in `aba` treated sanmples (AT5G52310), and one that is strongly downregulated (AT2G38310). 
